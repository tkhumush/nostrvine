  ...
  group('Camera Publish Flow Integration Tests', () {
    ...
    testWidgets(
      ...
      if (!kIsWeb && !Platform.isMacOS) {
        ...
        await tester.press(recordButtonFinder.at(1)); // The main record button
      ...
      expect(publishButton, findsOneWidget,
          reason: 'Publish button should appear after recording stops and creates segment');
    ...
    testWidgets(
      ...
      expect(find.text('Add Metadata'), findsNothing,
