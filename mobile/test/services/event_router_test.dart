...
void main() {
  group('EventRouter', () {
    ...
    test('handleEvent inserts kind 34236 (video) event to NostrEvents table',
        () async {
      ...
      final storedEvent = await db.nostrEventsDao.getEvent('bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb');
      expect(storedEvent, isNotNull);
      expect(storedEvent!.id, equals('bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb'));
      expect(storedEvent.kind, equals(34236));
      expect(storedEvent.pubkey, equals('aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa'));
    ...
    test('handleEvent inserts kind 0 (profile) event to both tables', () async {
      ...
      // Verify event was inserted to NostrEvents table
      final storedEvent = await db.nostrEventsDao.getEvent('eeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee');
      expect(storedEvent, isNotNull);
      expect(storedEvent!.kind, equals(0));

      // Verify profile was extracted to UserProfiles table
      final profile =
          await db.userProfilesDao.getProfile('dddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddd');
    ...
    test('handleEvent inserts kind 3 (contacts) event to NostrEvents table',
        () async {
      ...
      // Verify event was inserted to NostrEvents table
      final storedEvent =
          await db.nostrEventsDao.getEvent('2222222222222222222222222222222222222222222222222222222222222222');
      expect(storedEvent, isNotNull);
      expect(storedEvent!.kind, equals(3));
      expect(storedEvent.tags.length, equals(2));
    });

    test('handleEvent inserts kind 7 (reaction) event to NostrEvents table',
        () async {
      ...
      // Verify event was inserted to NostrEvents table
      final storedEvent = await db.nostrEventsDao.getEvent('5555555555555555555555555555555555555555555555555555555555555555');
      expect(storedEvent, isNotNull);
      expect(storedEvent!.kind, equals(7));
      expect(storedEvent.content, equals('+'));
    });

    test('handleEvent inserts kind 6 (repost) event to NostrEvents table',
        () async {
      ...
      repostEvent.id = '8888888888888888888888888888888888888888888888888888888888888888';
      repostEvent.sig = '9999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999';

      await eventRouter.handleEvent(repostEvent);

      // Verify event was inserted to NostrEvents table
      final storedEvent = await db.nostrEventsDao.getEvent('8888888888888888888888888888888888888888888888888888888888888888');
      expect(storedEvent, isNotNull);
    ...
    test('handleEvent handles duplicate events (upsert behavior)', () async {
      ...
      event1.id = 'cdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcd';
      event1.sig = 'efefefefefefefefefefefefefefefefefefefefefefefefefefefefefefefefefefefefefefefefefefefefefefefefefefefefefefefefefefefefefefefefefefefefefef';

      // Insert first time
      await eventRouter.handleEvent(event1);

      final storedEvent1 =
          await db.nostrEventsDao.getEvent('cdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcd');
      ...
      event2.id = 'cdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcd';
      event2.sig = '0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a';
      ...
      expect(storedEvent2.sig, equals('0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a'));
    });
    ...
    test('handleEvent handles malformed profile event gracefully', () async {
      ...
      malformedProfileEvent.id = 'a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1';
      malformedProfileEvent.sig = 'b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2';
      ...
      final storedEvent =
          await db.nostrEventsDao.getEvent('a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1');
      expect(storedEvent, isNotNull);
      expect(storedEvent!.kind, equals(0));

      // Profile should exist with minimal data (from fallback in UserProfile.fromNostrEvent)
      final profile =
          await db.userProfilesDao.getProfile('f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0');
      expect(profile, isNotNull);
      expect(profile!.pubkey, equals('f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0'));
    });
    ...
    test('handleEvent inserts unknown kind to NostrEvents table', () async {
      ...
      unknownKindEvent.id = 'd4d4d4d4d4d4d4d4d4d4d4d4d4d4d4d4d4d4d4d4d4d4d4d4d4d4d4d4d4d4d4d4';
      unknownKindEvent.sig = 'e5e5e5e5e5e5e5e5e5e5e5e5e5e5e5e5e5e5e5e5e5e5e5e5e5e5e5e5e5e5e5e5e5e5e5e5e5e5e5e5e5e5e5e5e5e5e5e5e5e5e5e5e5e5e5e5e5e5e5e5e5e5e5e5e5e5e5e5e5e5e5e5e5e5e5e5e5e5e5e5e5e5e5e5e5e5e5e5';

      await eventRouter.handleEvent(unknownKindEvent);

      // Verify event was inserted to NostrEvents table
      final storedEvent = await db.nostrEventsDao.getEvent('d4d4d4d4d4d4d4d4d4d4d4d4d4d4d4d4d4d4d4d4d4d4d4d4d4d4d4d4d4d4d4d4');
      expect(storedEvent, isNotNull);
