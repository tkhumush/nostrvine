...
void main() {
  group('NostrEventsDao.getEventCount', () {
    ...
    test('returns correct count after inserting events', () async {
      ...
      event1.id = 'event1000000000000000000000000000000000000000000000000000000001';
      event1.sig = 'sig1000000000000000000000000000000000000000000000000000000000001';
      ...
      event2.id = 'event2000000000000000000000000000000000000000000000000000000002';
      event2.sig = 'sig2000000000000000000000000000000000000000000000000000000000002';
      ...
      event3.id = 'event3000000000000000000000000000000000000000000000000000000003';
      event3.sig = 'sig3000000000000000000000000000000000000000000000000000000000003';
